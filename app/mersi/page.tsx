...
const ALBUMS: Album[] = [
  {
    id: "revakplim", title: "Rèv ak Plim", year: "2018",
    ...
    zipUrl: `${BASE}/revakplim/Rev-Ak-Plim.zip`,
  },
  {
    id: "eskal1", title: "Eskal I", year: "2022",
    ...
    zipUrl: `${BASE}/eskal1/Eskal-I.zip`,
  },
  {
    id: "ouvesekla", title: "Ouve Sek La", year: "2023",
    ...
    zipUrl: `${BASE}/ovesekla/Ouve-Sek-La.zip`,
  },
  {
    id: "mixtape4", title: "#4 Mixtape", year: "2021",
    ...
    zipUrl: `${BASE}/mixtape4/4-Mixtape.zip`,
  },
];
        ...
        {open && (
          <div className="mb-4 bg-ink/60 border border-parchment/10 rounded-sm p-3">
            ...
            <div className="flex items-center gap-2 mb-3">
              <button onClick={() => loadAndPlay((idx - 1 + album.tracks.length) % album.tracks.length)}
                className="text-parchment hover:text-ember">⏮</button>
              <button onClick={togglePlay} className="text-parchment hover:text-ember">
                {playing ? "⏸" : "▶"}
              </button>
              <button onClick={() => loadAndPlay((idx + 1) % album.tracks.length)}
                className="text-parchment hover:text-ember">⏭</button>
  ...
  return (
    <main>
      <section className="relative min-h-[55vh] flex flex-col items-center justify-center px-6 py-20 text-center"
        ...
        <div className="w-20 h-20 rounded-full bg-char border border-parchment/20 flex items-center justify-center text-4xl mb-8">🙏</div>
        ...
        <div className="max-w-lg bg-char/60 border border-parchment/15 border-l-[3px] border-l-blood rounded-sm p-7 text-left">
          ...
          <p className="text-bone/80 text-sm leading-relaxed mb-3">
            Pandan tan sa, kontinye koute epi telechaje tout mizik Def Fondamantal yo anba a — gratis, pou ou.
          </p>
          <p className="text-parchment/70 text-sm italic">
            Manifesto lage nèt <span className="font-display not-italic text-parchment">31 Jiyè</span>. Nou pral avèti ou.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-16 border-t border-parchment/10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-bone/50 text-sm max-w-md mx-auto">Koute epi telechaje tout album yo gratis.</p>
          </div>
