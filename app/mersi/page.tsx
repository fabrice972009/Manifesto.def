...
const ALBUMS = [
  {
    ...
    tracks: [
      { title: "Yon Ti Kounouk (Intro)",  url: "" },
      { title: "Plent",                   url: "" },
      { title: "Chimen Pèdi Tan",         url: "" },
      { title: "Rap Pa m",                url: "" },
      { title: "Nou 2 P Ap Mouri La",     url: "" },
      { title: "San Papye",               url: "" },
      { title: "Alice",                   url: "" },
      { title: "M P Ap Janm Bliye Ou",    url: "" },
      { title: "Neverland",               url: "" },
      { title: "Denyè Pasaje",            url: "" },
      { title: "Demen",                   url: "" },
      { title: "Nan Pakou M (Outro)",     url: "" },
    ],
    zipUrl: "",
  },
  {
    ...
    tracks: [
      { title: "Ouve Sek La",      url: "" },
      { title: "Rap Pis Ke Sa",    url: "" },
      { title: "Show Skillz",      url: "" },
      { title: "Levanjil Getho a", url: "" },
      { title: "Se Konsa Sa Ye",   url: "" },
      { title: "Sou Map La",       url: "" },
      { title: "Konvesasyon",      url: "" },
      { title: "Kranp Ke Vwa",     url: "" },
      { title: "Solo Ashh",        url: "" },
      { title: "Sou Beton",        url: "" },
      { title: "Malade",           url: "" },
      { title: "Pakou On Bal",     url: "" },
    ],
    zipUrl: "",
  },
  {
  ...
  },
  {
    ...
    cover: null,
    tracks: [
      { title: "Ak on Gyal",     url: "" },
      { title: "Rekadraj",       url: "" },
      { title: "Mi-Thug",        url: "" },
      { title: "Jou m kite Rap", url: "" },
      { title: "Listwa Be l",    url: "" },
      { title: "Mouri an Paix",  url: "" },
      { title: "Aswe a",         url: "" },
      { title: "Devan Jem",      url: "" },
      { title: "Numero 0",       url: "" },
      { title: "Nan Pakoum",     url: "" },
      { title: "Ouve Se k la",   url: "" },
      { title: "TFKL",           url: "" },
      { title: "Kasparov",       url: "" },
      { title: "Papa",           url: "" },
    ],
